...
#define ST7789_ENABLE_BACKLIGHT_CONTROL 1
...
#define CONFIG_LV_TFT_DISPLAY_X_OFFSET 34
...
#ifdef LV_DISPLAY_ST7789
#define LV_COLOR_DEPTH 16
/* 0 = 小端, 匹配 GUI-Guider 导出的 RGB565 图片数据(低字节在前); 勿改成 1, 否则图片颜色全错 */
#define LV_COLOR_16_SWAP 0
#endif
...
#define LV_COLOR_CHROMA_KEY lv_color_hex(0x000000)         /*black->transparent*/
...
#define LV_DISP_DEF_REFR_PERIOD 16      /*[ms] 30→16: 渲染快的帧及时送出, 动画帧率提升(渲染慢的帧由渲染耗时自然节流)*/
